...
* Then i added if else to record the state of anchor or sailing, so now i had state of whther anchor is down or not , logicc for storm and charybids.
* then i added if else for wrecked 
* after this i have all the states for lcd to dispaly 
